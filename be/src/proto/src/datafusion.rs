...
pub mod physical_plan_node {
    ...
    pub enum PhysicalPlanType {
        ...
        #[prost(message, tag = "30")]
        SqlScan(super::SqlScanExecNode),
        #[prost(message, tag = "31")]
        MergeJoin(::prost::alloc::boxed::Box<super::SortMergeJoinExecNode>),
    }
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct SortMergeJoinExecNode {
    ...
    #[prost(enumeration = "JoinType", tag = "5")]
    pub join_type: i32,
    #[prost(bool, tag = "6")]
    pub null_equals_null: bool,
    #[prost(message, repeated, tag = "8")]
    pub sort_options: ::prost::alloc::vec::Vec<SortOptions>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct SqlScanExecNode {
    #[prost(message, optional, tag = "1")]
    pub config: ::core::option::Option<SourceScanConfig>,
    #[prost(string, repeated, tag = "2")]
