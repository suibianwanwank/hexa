...
impl AsLogicalPlan for LogicalPlanNode {
    ...
    fn try_into_logical_plan(
        ...
        match plan {
            ...
            LogicalPlanType::DropView(dropview) => Ok(datafusion::logical_expr::LogicalPlan::Ddl(
                datafusion::logical_expr::DdlStatement::DropView(DropView {
            ...
            LogicalPlanType::CopyTo(copy) => {
                ...
                Ok(datafusion::logical_expr::LogicalPlan::Copy(
                    datafusion::logical_expr::dml::CopyTo {
                        input: Arc::new(input),
