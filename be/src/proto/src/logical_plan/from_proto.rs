            ...
            match window_function {
                window_expr_node::WindowFunction::AggrFunction(i) => {
                    ...
                    Ok(Expr::WindowFunction(WindowFunction::new(
                        datafusion::logical_expr::expr::WindowFunctionDefinition::AggregateFunction(
                            aggr_function,
                        ),
                ...
                window_expr_node::WindowFunction::BuiltInFunction(i) => {
                    ...
                    Ok(Expr::WindowFunction(WindowFunction::new(
                        datafusion::logical_expr::expr::WindowFunctionDefinition::BuiltInWindowFunction(
                            built_in_function,
                        ),
                        args,
                        partition_by,
                ...
                window_expr_node::WindowFunction::Udaf(udaf_name) => {
                    ...
                    let args = parse_optional_expr(expr.expr.as_deref(), registry)?
                        ...
                        .unwrap_or_else(Vec::new);
                    Ok(Expr::WindowFunction(WindowFunction::new(
                        datafusion::logical_expr::expr::WindowFunctionDefinition::AggregateUDF(
                            udaf_function,
                        ),
                        args,
                        partition_by,
                ...
                window_expr_node::WindowFunction::Udwf(udwf_name) => {
                    ...
                    let args = parse_optional_expr(expr.expr.as_deref(), registry)?
                        ...
                        .unwrap_or_else(Vec::new);
                    Ok(Expr::WindowFunction(WindowFunction::new(
                        datafusion::logical_expr::expr::WindowFunctionDefinition::WindowUDF(
                            udwf_function,
                        ),
                        args,
                        partition_by,
