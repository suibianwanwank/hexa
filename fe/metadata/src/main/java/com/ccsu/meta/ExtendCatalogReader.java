...
import com.ccsu.meta.type.MysqlTypeConverter;
...
public class ExtendCatalogReader implements Prepare.CatalogReader {
    ...
    public static ExtendCatalogReader create(String clusterId,
        ...
        //TODO remove mysql type converter
        SqlNameMatcher sqlNameMatcher = SqlNameMatchers.withCaseSensitive(isCaseSensitive);
        TypeConverter typeConverter = new MysqlTypeConverter(relDataTypeFactory);
        QueryMetadataManager queryMetadataManager =
                new QueryMetadataManagerImpl(metadataService, typeConverter, clusterId);
        ...
        return new ExtendCatalogReader(schemaPaths,
                calciteSchema, sqlNameMatcher, queryMetadataManager, relDataTypeFactory);
    }
    ...
    public Prepare.CatalogReader withSchemaPath(List<String> list) {
        return new ExtendCatalogReader(schemaPaths, rootSchema, sqlNameMatcher, metadata, relDataTypeFactory);
    }
