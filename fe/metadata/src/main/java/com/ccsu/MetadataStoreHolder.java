...
import com.ccsu.store.api.Entity;
...
public class MetadataStoreHolder {
    ...
    private final DataStore<MetaPath, CatalogInfo> catalogStore;

    private final DataStore<MetaPath, SchemaInfo> schemaStore;

    private final DataStore<MetaPath, TableInfo> tableStore;
    ...
    public MetadataStoreHolder(StoreManager storeManager) {
        ...
        catalogStore = storeManager.getOrCreateDataStore(new CatalogStoreConfig());
        schemaStore = storeManager.getOrCreateDataStore(new SchemaStoreConfig());
        tableStore = storeManager.getOrCreateDataStore(new TableStoreConfig());
    }
