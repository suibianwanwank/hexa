...
public class RelDecorrelator implements ReflectiveVisitor {
    ...
    public RelNode removeCorrelationViaRule(RelNode root) {
        final RelBuilderFactory f = relBuilderFactory();
        HepProgram program = HepProgram.builder()
                .addRuleInstance(RemoveSingleAggregateRule.config(this, f).toRule())
                .addRuleInstance(
    ...
    public static final class RemoveSingleAggregateRule
        ...
        static RemoveSingleAggregateRuleConfig config(RelDecorrelator decorrelator, RelBuilderFactory f) {
            return ImmutableRemoveSingleAggregateRuleConfig.builder().relBuilderFactory(f)
                    .operandSupplier(b0 ->
        ...
        public interface RemoveSingleAggregateRuleConfig extends Config {
            @Override
