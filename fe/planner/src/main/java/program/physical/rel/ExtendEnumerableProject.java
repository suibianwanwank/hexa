...
import arrow.datafusion.ProjectionNode;
...
public class ExtendEnumerableProject
    ...
    public ExtendEnumerableProject(RelOptCluster cluster, RelTraitSet traitSet, RelNode input, List<? extends RexNode> projects, RelDataType rowType) {
