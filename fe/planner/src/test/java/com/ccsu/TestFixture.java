...
public class TestFixture {
    ...
    protected void init() {
        ...
        metadataService = new MetadataServiceImpl(metaDataStoreHolder, storeManager);
    ...
    public void registerDefaultMetadata() {
        ...
        ColumnInfo column1 = ColumnInfo.builder().columnName("column1").columnType("VARCHAR").build();
        ColumnInfo column2 = ColumnInfo.builder().columnName("column2").columnType("BIGINT").build();
        ...
        ColumnInfo column3 = ColumnInfo.builder().columnName("column3").columnType("VARCHAR").build();
        ColumnInfo column4 = ColumnInfo.builder().columnName("column4").columnType("BIGINT").build();
